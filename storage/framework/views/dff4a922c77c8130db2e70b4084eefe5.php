            ...
            <form method="POST" action="<?php echo e(url('/login')); ?>" class="space-y-5">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input id="username" name="username" type="text" required placeholder="Masukkan username" value="<?php echo e(old('username')); ?>" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition">
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\pwi2sem5\resources\views/auth/login.blade.php ENDPATH**/ ?>